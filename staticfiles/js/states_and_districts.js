...
//         stateAndDistrictData.states.forEach(state => {
...
//     function populateDistrictsDropdown(selectedState) {
//         const districtsDropdown = document.getElementById('districtsDropdown');
//         const selectedStateData = stateAndDistrictData.states.find(state => state.state === selectedState);
